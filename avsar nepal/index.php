...
<body>
    ...
    <section class="dashboard-section">
        <div class="dashboard-container">
            <div class="dashboard-content">
                <h2 class="dashboard-title">Your personalized career hub</h2>
                <p class="dashboard-description">
                    Get tailored job recommendations, connect with employers from your school, 
                    and access exclusive career resources all in one place.
                </p>
                <button class="btn-explore">Explore dashboard</button>
            </div>
            <div class="dashboard-preview">
                <div class="dashboard-image-wrapper">
                    <!-- Placeholder for dashboard image -->
                    <img src="https://via.placeholder.com/1200x800" alt="Dashboard Preview" class="dashboard-image">
    ...
    <script>
        // Fetch and display live platform statistics
        async function loadLiveStats() {
            try {
                ...
                if (data.success && data.index) {
                    // Update network size
                    const networkStat = document.getElementById('network-size-stat');
                    if (networkStat && data.index.network_size) {
                        networkStat.textContent = data.index.network_size + '+ job seekers';
                    }
                    
                    // Update any other stats on the page
